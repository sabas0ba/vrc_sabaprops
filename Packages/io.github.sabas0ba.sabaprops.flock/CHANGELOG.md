...
- 最初の World 状況別 Sample に全 68 種を配置。種ごとの小型水槽 9 台、24 m 水槽、地上の鳥の視点を追加

- 鳥 27 種、魚・水生生物 41 種 (海、サンゴ礁、水槽・池) のプリセットと、パラメータから形状と模様を生成する body generator
...
- World の空・小型水槽・大型水槽・川、全 68 種、同種の動作比較を含む 3 つの Sample Scene と Unity RenderImage
