...
| Wander | 7 | 個体ごとに範囲内を楕円状に泳ぎ回る | 水槽の魚、エイ、サメ、アホウドリ |

## 空

![鳥 25 種の High 段の形状](images/generated/flock-birds.svg)
...
![海の魚 14 種の High 段の形状](images/generated/flock-sea-fish.svg)
...
| オニイトマキエイ | `manta` | 2.00 m | Wander | 3 | 幅の広い胸鰭、白い腹 |
| マダラトビエイ | `eagle-ray` | 1.20 m | Stream | 8 | 白い斑点、長い尾 |
| ツマグロ | `reef-shark` | 1.60 m | Wander | 5 | 上葉の長い尾鰭、大きな背鰭 |

## サンゴ礁

![サンゴ礁と水槽・池の魚 17 種の High 段の形状](images/generated/flock-reef-aquarium-fish.svg)
