...
"$UNITY_BIN" \
    ...
    -testFilter "SabaProps.Foliage.CITests;SabaProps.Foliage.WorldTests;SabaProps.SoftProps.WorldTests;SabaProps.StageCam.WorldTests;SabaProps.PutItems.Tests" \
