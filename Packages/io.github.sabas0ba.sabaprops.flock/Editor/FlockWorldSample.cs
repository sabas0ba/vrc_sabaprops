...
namespace SabaProps.Flock.Editors
{
    ...
    public static class FlockWorldSample
    {
        ...
        public static void GenerateForDistribution()
        {
            ...
            Box(small, "Room floor", new Vector3(0f, -0.1f, 0f), new Vector3(5f, 0.2f, 5f), wood);
            Box(small, "Room wall", new Vector3(0f, 1.5f, 1.5f), new Vector3(5f, 3f, 0.15f), wall);
            ...
            View(small, "Small tank - standing eye 1.65 m", new Vector3(0f, 1.65f, -1.1f), new Vector3(0f, 1.15f, 0f));
