...
- 群れの動き 14 種: 巡航、マーマレーション、V 字編隊、上昇気流での旋回、回遊列、ベイトボール、トルネード、水槽内の遊泳、固定配置、噴射移動、長周期の浮遊、広い独立飛行、タコの屈伸と惰性、底寄りの遊泳
- イカの収縮と移動の連動、タコの頭頂部を進行方向へ向ける姿勢と屈伸、触腕の揺れ、クラゲの脈動、ニワトリ・ヒヨコの歩行動作
