...
`Placement Weight` で複数種の混合比を決めます。既定は草 `1.0`、クローバー `0.5`、葦 `0.12`、ひまわり `0.06` で、
草の中にクローバーが混ざり、葦とひまわりがぽつぽつ立つ比率です。
...
サンプルの Clearing は 2,732 個体が 16 Renderer なので、影を有効にしても追加されるドローコールは 16 です。
