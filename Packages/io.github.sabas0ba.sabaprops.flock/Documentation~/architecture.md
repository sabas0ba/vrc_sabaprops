...
これらの群れでは個体の中心が範囲の壁から体長 1 つ分内側に収まります。Wander、FreeFlight、Jet、Float は独立した軌道です。動作と大きさのばらつきを含む High Mesh の到達半径を UV6 に焼き込み、範囲から一度だけ差し引きます。個体が入る十分な寸法の水槽では、旋回しても体が壁を越えないようにします。旧 Mesh の UV6 が空の場合は体長を余白に使います。変更後は群れを再生成してください。
